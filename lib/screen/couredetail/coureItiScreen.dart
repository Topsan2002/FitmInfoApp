...
import 'package:flutter_application_1/screen/couredetail/coureDetailItiScreen.dart';
import 'package:flutter_application_1/screen/couredetail/coureStrucItiScreen.dart';
...
class CourseITitScreen extends StatelessWidget {
  const CourseITitScreen({super.key});
                      ...
                      btnDd(
                        ...
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            CupertinoPageRoute(
                              builder: (context) => const CoureStrucItiScreen(),
                            ),
                          );
                        },
                      ),
                      ...
                      btnDd(
                        onPressed: () async {
                          ...
                          await prefs.setString(
                              'filepath', 'assets/file/news/iti.pdf');
                          Navigator.push(
                            context,
                            CupertinoPageRoute(
